<div class="Editor-Wrapper">
	<form name="wc-richTextEditor" id="wc-richTextEditor-form" class="wc-richTextEditor" action="#" method="post">
		...
		<!-- Editor text box -->
		<textarea class="editor-text-box"  id="editor-text-box" name="textareaBox" style="display:none" wrap="hard">hola textarea</textarea>
		<iframe class="editor-richText-box" value="Hola como estas?" id="editor-richText-box" name="richTextBox">hola iframe</iframe>
